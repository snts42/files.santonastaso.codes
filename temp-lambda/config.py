...
# For Lambda, environment variables are provided by AWS Lambda runtime
# No need to load from .env file in production
if os.getenv('AWS_LAMBDA_FUNCTION_NAME'):
    # Running in Lambda - don't load .env file
    pass
else:
...
def get_settings() -> Settings:
    aws_region = os.getenv("REGION") or os.getenv("AWS_REGION", "eu-west-1")
